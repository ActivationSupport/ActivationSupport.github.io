...
// Smartphones (2026-07-27): straight from the mst.att.com catalogue, so make/model AND the
// price are MST's own — no more hand-matching against att.com, and every row is priced.
// Tablet / Wearable / Hotspot / AIA are still the older hand-matched public-MSRP set and
// are stale — paste those MST categories in and re-run to replace them the same way.
//
