...
// Generated by _private/device-catalog/build.js + msrp_match.js from an mst.att.com export
// (Category/Make/Model/Storage) joined to AT&T's PUBLIC att.com retail price ("MSRP from"),
// hand-matched — not the dealer rack rate (that's confidential, only in MST, which is
// login-gated and unreachable here). installment = MSRP / 36 (AT&T's standard no-interest
// term); null where no public price was found for that device. Re-run to refresh.
var FBC_DEVICES = [
  ...
  { category:"Smartphone", make:"Apple", model:"iPhone 14 Pro Max", storage:"512GB", installment:27.78 },
  { category:"Smartphone", make:"Apple", model:"iPhone 15", storage:"128GB", installment:17.5 },
  { category:"Smartphone", make:"Apple", model:"iPhone 15", storage:"256GB", installment:17.5 },
  ...
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro Max", storage:"1TB", installment:33.33 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro Max", storage:"256GB", installment:33.33 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro Max", storage:"2TB", installment:33.33 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro Max", storage:"512GB", installment:33.33 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro", storage:"1TB", installment:30.56 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro", storage:"256GB", installment:30.56 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17 Pro", storage:"512GB", installment:30.56 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17", storage:"256GB", installment:23.06 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17", storage:"512GB", installment:23.06 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17e", storage:"256GB", installment:16.67 },
  { category:"Smartphone", make:"Apple", model:"iPhone 17e", storage:"512GB", installment:16.67 },
  { category:"Smartphone", make:"Apple", model:"iPhone Air", storage:"1TB", installment:27.78 },
  { category:"Smartphone", make:"Apple", model:"iPhone Air", storage:"256GB", installment:27.78 },
  { category:"Smartphone", make:"Apple", model:"iPhone Air", storage:"512GB", installment:27.78 },
  { category:"Smartphone", make:"AT&T", model:"amiGO Jr. Phone", storage:"128GB", installment:7.22 },
  { category:"Smartphone", make:"Google", model:"Pixel 10 Pro XL", storage:"256GB", installment:34.72 },
  { category:"Smartphone", make:"Google", model:"Pixel 10 Pro XL", storage:"512GB", installment:34.72 },
  { category:"Smartphone", make:"Google", model:"Pixel 10 Pro", storage:"128GB", installment:29.17 },
  { category:"Smartphone", make:"Google", model:"Pixel 10 Pro", storage:"256GB", installment:29.17 },
  { category:"Smartphone", make:"Google", model:"Pixel 10", storage:"128GB", installment:23.61 },
  { category:"Smartphone", make:"Google", model:"Pixel 10a", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Google", model:"Pixel 8", storage:"128GB", installment:23.33 },
  { category:"Smartphone", make:"Google", model:"Pixel 9a", storage:"128GB", installment:14.44 },
  { category:"Smartphone", make:"HTC", model:"One M9", storage:"32GB", installment:null },
  { category:"Smartphone", make:"Motorola", model:"moto g 2026", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Motorola", model:"moto g power 2026", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Motorola", model:"moto g stylus 2025", storage:"128GB", installment:8.19 },
  { category:"Smartphone", make:"Motorola", model:"moto g stylus 2026", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Motorola", model:"moto razr+ 2026", storage:"256GB", installment:29.03 },
  { category:"Smartphone", make:"Motorola", model:"razr ultra 2025 PANTONE", storage:"512GB", installment:36.67 },
  { category:"Smartphone", make:"Quality One Wireless", model:"Core-P6", storage:"64GB", installment:14.72 },
  { category:"Smartphone", make:"Samsung", model:"Galaxy A17 5G", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy A37 5G", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S25 Edge", storage:"256GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S25 FE", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S25", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26 Ultra", storage:"1TB", installment:36.11 },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26 Ultra", storage:"256GB", installment:36.11 },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26 Ultra", storage:"512GB", installment:36.11 },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26+", storage:"256GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26+", storage:"512GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26", storage:"256GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy S26", storage:"512GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy Xcover7 Pro", storage:"128GB", installment:null },
  { category:"Smartphone", make:"Samsung", model:"Galaxy Z Flip5", storage:"512GB", installment:null },
  { category:"Smartphone", make:"Sonim", model:"XP Pro Thermal", storage:"256GB", installment:18.06 },
  { category:"Smartphone", make:"Sonim", model:"XP Pro", storage:"256GB", installment:17.5 },
  { category:"Smartphone", make:"Sonim", model:"XP3plus 5G", storage:"32GB", installment:5.56 },
  { category:"Smartphone", make:"Sonim", model:"XP5plus 5G (No Knobs)", storage:"64GB", installment:10.42 },
  { category:"Smartphone", make:"Sonim", model:"XP5plus 5G (With Knobs)", storage:"64GB", installment:10.42 },
  { category:"Smartphone", make:"TCL", model:"Classic", storage:"8GB", installment:2.08 },
  { category:"Tablet", make:"Apple", model:"iPad (A16) 2025", storage:"128GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad (A16) 2025", storage:"256GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad (A16) 2025", storage:"512GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 11-inch (M4) 2026", storage:"128GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 11-inch (M4) 2026", storage:"1TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 11-inch (M4) 2026", storage:"256GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 11-inch (M4) 2026", storage:"512GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 13-inch (M4) 2026", storage:"128GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 13-inch (M4) 2026", storage:"1TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 13-inch (M4) 2026", storage:"256GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Air 13-inch (M4) 2026", storage:"512GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad mini (2024)", storage:"128GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 11-inch Nano-Texture Glass (M5) 2025", storage:"1TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 11-inch Nano-Texture Glass (M5) 2025", storage:"2TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 11-inch Standard Glass (M5) 2025", storage:"1TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 11-inch Standard Glass (M5) 2025", storage:"256GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 11-inch Standard Glass (M5) 2025", storage:"2TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 11-inch Standard Glass (M5) 2025", storage:"512GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 13-inch Nano-Texture Glass (M5) 2025", storage:"1TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 13-inch Nano-Texture Glass (M5) 2025", storage:"2TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 13-inch Standard Glass (M5) 2025", storage:"1TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 13-inch Standard Glass (M5) 2025", storage:"256GB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 13-inch Standard Glass (M5) 2025", storage:"2TB", installment:null },
  { category:"Tablet", make:"Apple", model:"iPad Pro 13-inch Standard Glass (M5) 2025", storage:"512GB", installment:null },
  { category:"Tablet", make:"Samsung", model:"Galaxy Tab A11+ 5G", storage:"128GB", installment:null },
  { category:"Tablet", make:"Samsung", model:"Galaxy Tab S10 FE 5G", storage:"128GB", installment:null },
  { category:"Tablet", make:"Samsung", model:"Galaxy Tab S10+ 5G", storage:"256GB", installment:null },
  { category:"Tablet", make:"TCL", model:"TAB 8 NXTPAPER 5G", storage:"64GB", installment:null },
